<html>
  <head>
    <title>Live Map :: Crisis Management System</title>
    ...
    function initialize() {
        ...
        if (!mymap.get('infoWin')) {
            mymap.set('infoWin', new google.maps.InfoWindow({
                pixelOffset: new google.maps.Size(0, -40)
            }));
        }
		document.getElementById("incident_open").innerHTML = myArr.length-1;
        // Place markers on map
        for (b = 1; b < myArr.length; b++) {
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="row" style="padding-bottom:14px;">
              <div class="col-lg-6" style="font-size:18px"><i class="fa fa-exclamation-triangle" style="color:red"></i> Current Incidents: &nbsp;<b><span id="incident_open" style="color:red;font-size:24px"></span></b></div>
              <div class="col-lg-6"><a style="margin-left:5px" class="btn btn-md btn-primary pull-right" onclick="mymap2.setCenter(new google.maps.LatLng(1.354625,103.818740));mymap2.setZoom(12);">RESET ZOOM</a>
