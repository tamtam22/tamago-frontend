<html>
  <head>
    ...
    <style type="text/css">html,body{height:100%;margin:0;padding:0}#map{height:400px}
      .labels {
      color: white;
  ...
  <body>
          ...
          <div class="col-lg-12 col-sm-12 col-md-12">
            <div class="panel panel-default">
              <div class="panel-body">
                <div class="alert alert-info" style="text-align:center;padding:5px 0;font-size:16px;">Double click on an incident below to zoom in to incident location</div>
    ...
    <script type="text/javascript">
      ...
      $(document).ajaxComplete(function() {
       if(incident_count2 == -1) {incident_count2 = incident_count;}
          else {if(incident_count != incident_count2) {location.reload();}}
      });
    </script>
  </body>
</html>